...
export const SEO: Record<string, SeoMeta> = {
  ...
  books: {
    ...
    description:
      'Иллюстрированная сказка в PDF с озвучкой, где главный герой - ваш ребёнок. Десять сюжетов про страх темноты, засыпание, злость, садик и первые важные шаги. 250 ₽',
  },
  library: {
    path: '/library',
