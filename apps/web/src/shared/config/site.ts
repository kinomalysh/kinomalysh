...
export const siteConfig = {
  ...
  description:
    'Загрузите одно фото - нейросеть создаст персональный мультфильм, где ваш ребёнок главный герой. Готово за 15 минут, 1 990 ₽. Иллюстрированная книга - 250 ₽',
  ...
  facts: [
    ...
    'Книга с иллюстрациями - 250 ₽',
    'Супергеройский мультфильм - 3 490 ₽, семейный набор 3+1 - 5 990 ₽',
    'Кастинг героя бесплатный: до оплаты показываем три мультяшных портрета ребёнка, можно попросить перерисовать',
...
export const SEO: Record<string, SeoMeta> = {
  ...
  cartoons: {
    path: '/multfilmy',
    title: 'Персональные мультфильмы по фото ребёнка - Киномалыш',
    description:
      'Мультфильм на две минуты, где ваш ребёнок играет главную роль. Одно фото, готово за 15 минут, 1 990 ₽',
  },
  books: {
    path: '/knigi',
    title: 'Персональные детские книги по фото ребёнка - Киномалыш',
    description:
      'Иллюстрированная сказка в PDF, где главный герой - ваш ребёнок. Десять сюжетов про страх темноты, засыпание, злость, садик и первые важные шаги. 250 ₽',
  },
  library: {
    path: '/library',
