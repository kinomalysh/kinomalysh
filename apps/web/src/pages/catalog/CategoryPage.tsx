...
const COPY: Record<Kind, { seo: 'books' | 'cartoons'; kicker: string; title: string; lead: string }> =
  {
    book: {
      ...
      lead: 'Иллюстрированная книга в PDF с озвучкой. Каждая история про одно настоящее детское чувство: страх темноты, злость, расставание с мамой, первый раз у врача. Читается на телефоне прямо в вашей библиотеке.',
    },
    video: {
      seo: 'cartoons',
      kicker: 'Мультфильмы',
