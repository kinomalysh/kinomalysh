...
const STEPS = [
  ...
  },
  {
    ...
    text: 'Нейросеть рисует три мультяшных портрета. Не похож — перерисуем бесплатно, сколько угодно раз.',
    note: 'платить пока не нужно',
  },
  {
    title: 'Сюжет и кадры',
    text: 'Выбираете, какой вечер спасаем, и утверждаете сцены до оплаты. Вы решаете, что попадёт в мультфильм.',
    note: 'вы — режиссёр',
  },
  {
  ...
  return (
    <section ref={ref} aria-labelledby="magic-heading" className="py-12">
      ...
      <p className="hand-note mx-auto mt-6 max-w-xs text-center text-lg">
        похож или нет — решаете вы. рисуем варианты бесплатно
      </p>
    </section>
  )
}
